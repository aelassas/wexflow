namespace Wexflow.Core.Db.MySQL
{
    public class Entry : Core.Db.Entry
    {
        ...
        public const string TableStruct = "(" + ColumnNameId + " INT NOT NULL AUTO_INCREMENT, " + ColumnNameName + " VARCHAR(255), " + ColumnNameDescription + " VARCHAR(255), " + ColumnNameLaunchType + " INT, " + ColumnNameStatusDate + " TIMESTAMP, " + ColumnNameStatus + " INT, " + ColumnNameWorkflowId + " INT, " + ColumnNameJobId + " VARCHAR(255), " + ColumnNameLogs + " LONGTEXT, CONSTRAINT " + DocumentName + "_pk PRIMARY KEY (" + ColumnNameId + "))";
