namespace Wexflow.Core.Db.SQLite
{
    public class Entry : Core.Db.Entry
    {
        ...
        public static readonly string TableStruct = "(" + ColumnName_Id + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, " + ColumnName_Name + " TEXT, " + ColumnName_Description + " TEXT, " + ColumnName_LaunchType + " INTEGER, " + ColumnName_StatusDate + " TEXT, " + ColumnName_Status + " INTEGER, " + ColumnName_WorkflowId + " INTEGER, " + ColumnName_JobId + " TEXT, " + ColumnName_Logs + " TEXT)";
