namespace Wexflow.Core.Db.PostgreSQL
{
    public class Entry : Core.Db.Entry
    {
        ...
        public const string TableStruct = "(" + COLUMN_NAME_ID + " SERIAL PRIMARY KEY, " + COLUMN_NAME_NAME + " VARCHAR(255), " + COLUMN_NAME_DESCRIPTION + " VARCHAR(255), " + COLUMN_NAME_LAUNCH_TYPE + " INT, " + COLUMN_NAME_STATUS_DATE + " TIMESTAMP, " + COLUMN_NAME_STATUS + " INT, " + COLUMN_NAME_WORKFLOW_ID + " INT, " + COLUMN_NAME_JOB_ID + " VARCHAR(255), " + COLUMN_NAME_LOGS + " VARCHAR)";
