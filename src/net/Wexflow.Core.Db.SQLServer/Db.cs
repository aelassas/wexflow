        ...
        public override IEnumerable<Core.Db.User> GetAdministrators(string keyword, UserOrderBy uo)
        {
            lock (Padlock)
            {
                ...
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("SELECT " + User.ColumnNameId + ", "
        ...
        public override DateTime GetEntryStatusDateMax()
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("SELECT TOP 1 " + Entry.ColumnNameStatusDate
                        + " FROM " + Core.Db.Entry.DocumentName
        ...
        public override DateTime GetHistoryEntryStatusDateMax()
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("SELECT TOP 1 " + HistoryEntry.ColumnNameStatusDate
                        + " FROM " + Core.Db.HistoryEntry.DocumentName
        ...
        public override string GetPassword(string username)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("SELECT " + User.ColumnNamePassword
                        + " FROM " + Core.Db.User.DocumentName
        ...
        public override Core.Db.StatusCount GetStatusCount()
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("SELECT " + StatusCount.ColumnNameId + ", "
                        + StatusCount.ColumnNamePendingCount + ", "
                        + StatusCount.ColumnNameRunningCount + ", "
                        + StatusCount.ColumnNameDoneCount + ", "
                        + StatusCount.ColumnNameFailedCount + ", "
        ...
        public override IEnumerable<string> GetUserWorkflows(string userId)
        {
            lock (Padlock)
            {
                ...
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("SELECT " + UserWorkflow.ColumnNameId + ", "
        ...
        public override Core.Db.Workflow GetWorkflow(string id)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("SELECT " + Workflow.ColumnNameId + ", "
        ...
        public override string GetEntryLogs(string entryId)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("SELECT " + Entry.ColumnNameLogs
                        + " FROM " + Core.Db.Entry.DocumentName
                        + " WHERE "
        ...
        public override string GetHistoryEntryLogs(string entryId)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("SELECT " + HistoryEntry.ColumnNameLogs
                        + " FROM " + Core.Db.HistoryEntry.DocumentName
                        + " WHERE "
        ...
        public override string InsertRecord(Core.Db.Record record)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("INSERT INTO " + Core.Db.Record.DocumentName + "("
        ...
        public override void UpdateRecord(string recordId, Core.Db.Record record)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("UPDATE " + Core.Db.Record.DocumentName + " SET "
        ...
        public override string InsertVersion(Core.Db.Version version)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("INSERT INTO " + Core.Db.Version.DocumentName + "("
        ...
        public override void UpdateVersion(string versionId, Core.Db.Version version)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("UPDATE " + Core.Db.Version.DocumentName + " SET "
        ...
        public override string InsertNotification(Core.Db.Notification notification)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("INSERT INTO " + Core.Db.Notification.DocumentName + "("
        ...
        public override string InsertApprover(Core.Db.Approver approver)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("INSERT INTO " + Core.Db.Approver.DocumentName + "("
        ...
        public override void UpdateApprover(string approverId, Core.Db.Approver approver)
        {
            lock (Padlock)
            {
                using (var conn = new SqlConnection(_connectionString))
                {
                    ...
                    using (var command = new SqlCommand("UPDATE " + Core.Db.Approver.DocumentName + " SET "
