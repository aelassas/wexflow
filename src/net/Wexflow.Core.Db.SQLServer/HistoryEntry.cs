namespace Wexflow.Core.Db.SQLServer
{
    public class HistoryEntry : Core.Db.HistoryEntry
    {
        ...
        public const string TableStruct = "(" + COLUMN_NAME_ID + " INT IDENTITY(1,1) PRIMARY KEY, " + COLUMN_NAME_NAME + " VARCHAR(255), " + COLUMN_NAME_DESCRIPTION + " VARCHAR(255), " + COLUMN_NAME_LAUNCH_TYPE + " INT, " + COLUMN_NAME_STATUS_DATE + " DATETIME, " + COLUMN_NAME_STATUS + " INT, " + COLUMN_NAME_WORKFLOW_ID + " INT, " + COLUMN_NAME_LOGS + " VARCHAR(MAX))";
