namespace Wexflow.Core.Db.Firebird
{
    public class Entry : Core.Db.Entry
    {
        ...
        public static readonly string TableStruct = "(" + ColumnName_Id + " integer generated by default as identity primary key, " + ColumnName_Name + " VARCHAR(255), " + ColumnName_Description + " VARCHAR(255), " + ColumnName_LaunchType + " INTEGER, " + ColumnName_StatusDate + " TIMESTAMP, " + ColumnName_Status + " INTEGER, " + ColumnName_WorkflowId + " INTEGER, " + ColumnName_JobId + " VARCHAR(255), " + ColumnName_Logs + " BLOB SUB_TYPE TEXT)";
