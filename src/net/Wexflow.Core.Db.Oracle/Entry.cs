namespace Wexflow.Core.Db.Oracle
{
    public class Entry : Core.Db.Entry
    {
        ...
        public static readonly string TableStruct = "(" + ColumnName_Id + " NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " + ColumnName_Name + " VARCHAR2(255), " + ColumnName_Description + " VARCHAR2(255), " + ColumnName_LaunchType + " INTEGER, " + ColumnName_StatusDate + " TIMESTAMP, " + ColumnName_Status + " INTEGER, " + ColumnName_WorkflowId + " INTEGER, " + ColumnName_JobId + " VARCHAR2(255), " + ColumnName_Logs + " CLOB)";
