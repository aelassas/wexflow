namespace Wexflow.Core.Db.Oracle
{
    public class HistoryEntry : Core.Db.HistoryEntry
    {
        ...
        public static readonly string TableStruct = "(" + ColumnName_Id + " NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " + ColumnName_Name + " VARCHAR2(32767), " + ColumnName_Description + " VARCHAR2(32767), " + ColumnName_LaunchType + " INTEGER, " + ColumnName_StatusDate + " TIMESTAMP, " + ColumnName_Status + " INTEGER, " + ColumnName_WorkflowId + " INTEGER, " + ColumnName_Logs + " CLOB)";
