namespace Wexflow.Core.Db.Firebird
{
    public class Entry : Core.Db.Entry
    {
        ...
        public const string TABLE_STRUCT = "(" + COLUMN_NAME_ID + " integer generated by default as identity primary key, " + COLUMN_NAME_NAME + " VARCHAR(255), " + COLUMN_NAME_DESCRIPTION + " VARCHAR(255), " + COLUMN_NAME_LAUNCH_TYPE + " INTEGER, " + COLUMN_NAME_STATUS_DATE + " TIMESTAMP, " + COLUMN_NAME_STATUS + " INTEGER, " + COLUMN_NAME_WORKFLOW_ID + " INTEGER, " + COLUMN_NAME_JOB_ID + " VARCHAR(255), " + COLUMN_NAME_LOGS + " BLOB SUB_TYPE TEXT)";
