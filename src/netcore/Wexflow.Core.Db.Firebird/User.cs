namespace Wexflow.Core.Db.Firebird
{
    public class User : Core.Db.User
    {
        ...
        public static readonly string TableStruct = "(" + ColumnName_Id + " integer generated by default as identity primary key, " + ColumnName_Username + " VARCHAR(255), " + ColumnName_Password + " VARCHAR(255), " + ColumnName_UserProfile + " INTEGER, " + ColumnName_Email + " VARCHAR(255), " + ColumnName_CreatedOn + " TIMESTAMP, " + ColumnName_ModifiedOn + " TIMESTAMP)";
