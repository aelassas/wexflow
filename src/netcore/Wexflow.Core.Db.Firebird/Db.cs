    ...
    public sealed class Db : Core.Db.Db
    {
        ...
        public override void Init()
        {
            ...
            using (FbConnection conn = new(_connectionString))
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.StatusCount.DOCUMENT_NAME + "("
            ...
            using (FbConnection conn = new(_connectionString))
            {
                ...
                using FbCommand command = new("SELECT COUNT(*) FROM " + Core.Db.User.DOCUMENT_NAME + ";", conn);
        ...
        public override bool CheckUserWorkflow(string userId, string workflowId)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("SELECT COUNT(*) FROM " + Core.Db.UserWorkflow.DOCUMENT_NAME
        ...
        public override void ClearEntries()
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("DELETE FROM " + Core.Db.Entry.DOCUMENT_NAME + ";", conn);
                _ = command.ExecuteNonQuery();
            }
        }
        ...
        public override void ClearStatusCount()
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("DELETE FROM " + Core.Db.StatusCount.DOCUMENT_NAME + ";", conn);
                _ = command.ExecuteNonQuery();
            }
        }
        ...
        public override void DeleteUser(string username, string password)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("DELETE FROM " + Core.Db.User.DOCUMENT_NAME
        ...
        public override void DeleteUserWorkflowRelationsByUserId(string userId)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("DELETE FROM " + Core.Db.UserWorkflow.DOCUMENT_NAME
        ...
        public override void DeleteWorkflow(string id)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("DELETE FROM " + Core.Db.Workflow.DOCUMENT_NAME
        ...
        public override IEnumerable<Core.Db.User> GetAdministrators(string keyword, UserOrderBy uo)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("SELECT " + User.COLUMN_NAME_ID + ", "
        ...
        public override DateTime GetEntryStatusDateMax()
        {
            lock (Padlock)
            {
                using (FbConnection conn = new(_connectionString))
                {
                    ...
                    using FbCommand command = new("SELECT FIRST 1 " + Entry.COLUMN_NAME_STATUS_DATE
                        + " FROM " + Core.Db.Entry.DOCUMENT_NAME
        ...
        public override DateTime GetHistoryEntryStatusDateMax()
        {
            lock (Padlock)
            {
                using (FbConnection conn = new(_connectionString))
                {
                    ...
                    using FbCommand command = new("SELECT FIRST 1 " + HistoryEntry.COLUMN_NAME_STATUS_DATE
                        + " FROM " + Core.Db.HistoryEntry.DOCUMENT_NAME
        ...
        public override string GetPassword(string username)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("SELECT " + User.COLUMN_NAME_PASSWORD
                    + " FROM " + Core.Db.User.DOCUMENT_NAME
        ...
        public override Core.Db.StatusCount GetStatusCount()
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("SELECT " + StatusCount.COLUMN_NAME_ID + ", "
                    + StatusCount.COLUMN_NAME_PENDING_COUNT + ", "
                    + StatusCount.COLUMN_NAME_RUNNING_COUNT + ", "
                    + StatusCount.COLUMN_NAME_DONE_COUNT + ", "
                    + StatusCount.COLUMN_NAME_FAILED_COUNT + ", "
        ...
        public override IEnumerable<string> GetUserWorkflows(string userId)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("SELECT " + UserWorkflow.COLUMN_NAME_ID + ", "
        ...
        public override Core.Db.Workflow GetWorkflow(string id)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("SELECT " + Workflow.COLUMN_NAME_ID + ", "
        ...
        private static void IncrementStatusCountColumn(string statusCountColumnName)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("UPDATE " + Core.Db.StatusCount.DOCUMENT_NAME + " SET " + statusCountColumnName + " = " + statusCountColumnName + " + 1;", conn);
                _ = command.ExecuteNonQuery();
            }
        }
        ...
        public override void InsertEntry(Core.Db.Entry entry)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.Entry.DOCUMENT_NAME + "("
                    + Entry.COLUMN_NAME_NAME + ", "
                    + Entry.COLUMN_NAME_DESCRIPTION + ", "
                    + Entry.COLUMN_NAME_LAUNCH_TYPE + ", "
                    + Entry.COLUMN_NAME_STATUS_DATE + ", "
        ...
        public override void InsertHistoryEntry(Core.Db.HistoryEntry entry)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.HistoryEntry.DOCUMENT_NAME + "("
                    + HistoryEntry.COLUMN_NAME_NAME + ", "
                    + HistoryEntry.COLUMN_NAME_DESCRIPTION + ", "
                    + HistoryEntry.COLUMN_NAME_LAUNCH_TYPE + ", "
                    + HistoryEntry.COLUMN_NAME_STATUS_DATE + ", "
        ...
        public override void InsertUser(Core.Db.User user)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.User.DOCUMENT_NAME + "("
                    + User.COLUMN_NAME_USERNAME + ", "
                    + User.COLUMN_NAME_PASSWORD + ", "
                    + User.COLUMN_NAME_USER_PROFILE + ", "
                    + User.COLUMN_NAME_EMAIL + ", "
        ...
        public override void InsertUserWorkflowRelation(Core.Db.UserWorkflow userWorkflow)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.UserWorkflow.DOCUMENT_NAME + "("
                    + UserWorkflow.COLUMN_NAME_USER_ID + ", "
        ...
        public override string InsertWorkflow(Core.Db.Workflow workflow)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.Workflow.DOCUMENT_NAME + "("
        ...
        public override void UpdateEntry(string id, Core.Db.Entry entry)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("UPDATE " + Core.Db.Entry.DOCUMENT_NAME + " SET "
        ...
        public override void UpdatePassword(string username, string password)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("UPDATE " + Core.Db.User.DOCUMENT_NAME + " SET "
        ...
        public override void UpdateWorkflow(string dbId, Core.Db.Workflow workflow)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("UPDATE " + Core.Db.Workflow.DOCUMENT_NAME + " SET "
        ...
        public override string GetEntryLogs(string entryId)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("SELECT " + Entry.COLUMN_NAME_LOGS
                    + " FROM " + Core.Db.Entry.DOCUMENT_NAME
                    + " WHERE "
        ...
        public override string GetHistoryEntryLogs(string entryId)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("SELECT " + HistoryEntry.COLUMN_NAME_LOGS
                    + " FROM " + Core.Db.HistoryEntry.DOCUMENT_NAME
                    + " WHERE "
        ...
        public override string InsertRecord(Core.Db.Record record)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.Record.DOCUMENT_NAME + "("
        ...
        public override void UpdateRecord(string recordId, Core.Db.Record record)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("UPDATE " + Core.Db.Record.DOCUMENT_NAME + " SET "
        ...
        public override void DeleteRecords(string[] recordIds)
        {
            lock (Padlock)
            {
                if (recordIds.Length > 0)
                {
                    ...
                    using FbCommand command = new("DELETE FROM " + Core.Db.Record.DOCUMENT_NAME
        ...
        public override string InsertVersion(Core.Db.Version version)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.Version.DOCUMENT_NAME + "("
        ...
        public override void UpdateVersion(string versionId, Core.Db.Version version)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("UPDATE " + Core.Db.Version.DOCUMENT_NAME + " SET "
        ...
        public override void DeleteVersions(string[] versionIds)
        {
            lock (Padlock)
            {
                if (versionIds.Length > 0)
                {
                    ...
                    using FbCommand command = new("DELETE FROM " + Core.Db.Version.DOCUMENT_NAME
        ...
        public override string InsertNotification(Core.Db.Notification notification)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.Notification.DOCUMENT_NAME + "("
        ...
        public override void MarkNotificationsAsRead(string[] notificationIds)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("UPDATE " + Core.Db.Notification.DOCUMENT_NAME
        ...
        public override void DeleteNotifications(string[] notificationIds)
        {
            lock (Padlock)
            {
                if (notificationIds.Length > 0)
                {
                    ...
                    using FbCommand command = new("DELETE FROM " + Core.Db.Notification.DOCUMENT_NAME
                        + " WHERE " + Notification.COLUMN_NAME_ID + " IN " + builder + ";", conn);
                    _ = command.ExecuteNonQuery();
                }
            }
        ...
        public override string InsertApprover(Core.Db.Approver approver)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("INSERT INTO " + Core.Db.Approver.DOCUMENT_NAME + "("
        ...
        public override void UpdateApprover(string approverId, Core.Db.Approver approver)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("UPDATE " + Core.Db.Approver.DOCUMENT_NAME + " SET "
        ...
        public override void DeleteApproversByRecordId(string recordId)
        {
            lock (Padlock)
            {
                ...
                using FbCommand command = new("DELETE FROM " + Core.Db.Approver.DOCUMENT_NAME
