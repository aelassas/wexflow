namespace Wexflow.Core.Db.PostgreSQL
{
    public class Entry : Core.Db.Entry
    {
        ...
        public const string TableStruct = "(" + ColumnName_Id + " SERIAL PRIMARY KEY, " + ColumnName_Name + " VARCHAR(255), " + ColumnName_Description + " VARCHAR(255), " + ColumnName_LaunchType + " INT, " + ColumnName_StatusDate + " TIMESTAMP, " + ColumnName_Status + " INT, " + ColumnName_WorkflowId + " INT, " + ColumnName_JobId + " VARCHAR(255), " + ColumnName_Logs + " VARCHAR)";
