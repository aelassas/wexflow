namespace Wexflow.Core.Db.Oracle
{
    public class User : Core.Db.User
    {
        ...
        public const string TableStruct = "(" + COLUMN_NAME_ID + " NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " + COLUMN_NAME_USERNAME + " VARCHAR2(255), " + COLUMN_NAME_PASSWORD + " VARCHAR2(255), " + COLUMN_NAME_USER_PROFILE + " INTEGER, " + COLUMN_NAME_EMAIL + " VARCHAR2(255), " + COLUMN_NAME_CREATED_ON + " TIMESTAMP, " + COLUMN_NAME_MODIFIED_ON + " TIMESTAMP)";
