namespace Wexflow.Core.Db.Oracle
{
    public class User : Core.Db.User
    {
        ...
        public static readonly string TableStruct = "(" + ColumnName_Id + " NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " + ColumnName_Username + " VARCHAR2(32767), " + ColumnName_Password + " VARCHAR2(32767), " + ColumnName_UserProfile + " INTEGER, " + ColumnName_Email + " VARCHAR2(32767), " + ColumnName_CreatedOn + " TIMESTAMP, " + ColumnName_ModifiedOn + " TIMESTAMP)";
