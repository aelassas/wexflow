namespace Wexflow.Core.Db.Oracle
{
    public class UserWorkflow : Core.Db.UserWorkflow
    {
        ...
        public const string TableStruct = "(" + COLUMN_NAME_ID + " NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " + COLUMN_NAME_USER_ID + " INTEGER, " + COLUMN_NAME_WORKFLOW_ID + " INTEGER)";
