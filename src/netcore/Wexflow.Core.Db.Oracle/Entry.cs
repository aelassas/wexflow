namespace Wexflow.Core.Db.Oracle
{
    public class Entry : Core.Db.Entry
    {
        ...
        public const string TableStruct = "(" + COLUMN_NAME_ID + " NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " + COLUMN_NAME_NAME + " VARCHAR2(255), " + COLUMN_NAME_DESCRIPTION + " VARCHAR2(255), " + COLUMN_NAME_LAUNCH_TYPE + " INTEGER, " + COLUMN_NAME_STATUS_DATE + " TIMESTAMP, " + COLUMN_NAME_STATUS + " INTEGER, " + COLUMN_NAME_WORKFLOW_ID + " INTEGER, " + COLUMN_NAME_JOB_ID + " VARCHAR2(255), " + COLUMN_NAME_LOGS + " CLOB)";
