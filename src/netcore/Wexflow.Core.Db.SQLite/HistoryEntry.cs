namespace Wexflow.Core.Db.SQLite
{
    public class HistoryEntry : Core.Db.HistoryEntry
    {
        ...
        public const string TABLE_STRUCT = "(" + COLUMN_NAME_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, " + COLUMN_NAME_NAME + " TEXT, " + COLUMN_NAME_DESCRIPTION + " TEXT, " + COLUMN_NAME_LAUNCH_TYPE + " INTEGER, " + COLUMN_NAME_STATUS_DATE + " TEXT, " + COLUMN_NAME_STATUS + " INTEGER, " + COLUMN_NAME_WORKFLOW_ID + " INTEGER, " + COLUMN_NAME_LOGS + " TEXT)";
