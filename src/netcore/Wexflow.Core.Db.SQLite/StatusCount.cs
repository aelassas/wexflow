namespace Wexflow.Core.Db.SQLite
{
    public class StatusCount : Core.Db.StatusCount
    {
        ...
        public const string TableStruct = "(" + COLUMN_NAME_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, " + COLUMN_NAME_PENDING_COUNT + " INTEGER, " + COLUMN_NAME_RUNNING_COUNT + " INTEGER, " + COLUMN_NAME_DONE_COUNT + " INTEGER, " + COLUMN_NAME_FAILED_COUNT + " INTEGER, " + COLUMN_NAME_WARNING_COUNT + " INTEGER, " + COLUMN_NAME_DISABLED_COUNT + " INTEGER, " + COLUMN_NAME_STOPPED_COUNT + " INTEGER, " + COLUMN_NAME_REJECTED_COUNT + " INTEGER)";
