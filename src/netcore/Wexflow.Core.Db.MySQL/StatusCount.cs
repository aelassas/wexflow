namespace Wexflow.Core.Db.MySQL
{
    public class StatusCount : Core.Db.StatusCount
    {
        ...
        public const string TableStruct = "(" + COLUMN_NAME_ID + " INT NOT NULL AUTO_INCREMENT, " + COLUMN_NAME_PENDING_COUNT + " INT, " + COLUMN_NAME_RUNNING_COUNT + " INT, " + COLUMN_NAME_DONE_COUNT + " INT, " + COLUMN_NAME_FAILED_COUNT + " INT, " + COLUMN_NAME_WARNING_COUNT + " INT, " + COLUMN_NAME_DISABLED_COUNT + " INT, " + COLUMN_NAME_STOPPED_COUNT + " INT, " + COLUMN_NAME_REJECTED_COUNT + " INT, CONSTRAINT " + DocumentName + "_pk PRIMARY KEY (" + COLUMN_NAME_ID + "))";
