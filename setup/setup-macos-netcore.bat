...
xcopy ..\samples\netcore\macos\WexflowTesting\* %dstDir%\WexflowTesting\ /s /e /y
...
:: Wexflow server
dotnet publish ..\src\netcore\Wexflow.Server\Wexflow.Server.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Server
copy netcore\macos\appsettings.json %dstDir%\Wexflow.Server

:: MongoDB script
dotnet publish ..\src\netcore\Wexflow.Scripts.MongoDB\Wexflow.Scripts.MongoDB.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.MongoDB
...
:: RavenDB script
::dotnet publish ..\src\netcore\Wexflow.Scripts.RavenDB\Wexflow.Scripts.RavenDB.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.RavenDB
::copy netcore\macos\RavenDB\appsettings.json %dstDir%\Wexflow.Scripts.RavenDB

:: PostgreSQL script
dotnet publish ..\src\netcore\Wexflow.Scripts.PostgreSQL\Wexflow.Scripts.PostgreSQL.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.PostgreSQL
copy netcore\macos\PostgreSQL\appsettings.json %dstDir%\Wexflow.Scripts.PostgreSQL

:: SQLServer script
dotnet publish ..\src\netcore\Wexflow.Scripts.SQLServer\Wexflow.Scripts.SQLServer.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.SQLServer
copy netcore\macos\SQLServer\appsettings.json %dstDir%\Wexflow.Scripts.SQLServer

:: MySQL script
dotnet publish ..\src\netcore\Wexflow.Scripts.MySQL\Wexflow.Scripts.MySQL.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.MySQL
copy netcore\macos\MySQL\appsettings.json %dstDir%\Wexflow.Scripts.MySQL

:: SQLite script
dotnet publish ..\src\netcore\Wexflow.Scripts.SQLite\Wexflow.Scripts.SQLite.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.SQLite
copy netcore\macos\SQLite\appsettings.json %dstDir%\Wexflow.Scripts.SQLite

:: LiteDB script
dotnet publish ..\src\netcore\Wexflow.Scripts.LiteDB\Wexflow.Scripts.LiteDB.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.LiteDB
copy netcore\macos\LiteDB\appsettings.json %dstDir%\Wexflow.Scripts.LiteDB

:: Firebird script
::dotnet publish ..\src\netcore\Wexflow.Scripts.Firebird\Wexflow.Scripts.Firebird.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.Firebird
::copy netcore\macos\Firebird\appsettings.json %dstDir%\Wexflow.Scripts.Firebird

:: Oracle script
@REM dotnet publish ..\src\netcore\Wexflow.Scripts.Oracle\Wexflow.Scripts.Oracle.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.Oracle
@REM copy netcore\macos\Oracle\appsettings.json %dstDir%\Wexflow.Scripts.Oracle

:: MariaDB script
::dotnet publish ..\src\netcore\Wexflow.Scripts.MariaDB\Wexflow.Scripts.MariaDB.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.MariaDB
::copy netcore\macos\MariaDB\appsettings.json %dstDir%\Wexflow.Scripts.MariaDB

:: Wexflow.Clients.CommandLine
dotnet publish ..\src\netcore\Wexflow.Clients.CommandLine\Wexflow.Clients.CommandLine.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Clients.CommandLine

:: Wexflow.Scripts.RunAllWorkflows
dotnet publish ..\src\netcore\Wexflow.Scripts.RunAllWorkflows\Wexflow.Scripts.RunAllWorkflows.csproj --framework net10.0 --runtime osx-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.RunAllWorkflows
