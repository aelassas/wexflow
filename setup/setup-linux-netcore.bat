...
:: Wexflow server
dotnet publish ..\src\netcore\Wexflow.Server\Wexflow.Server.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Server
copy netcore\linux\appsettings.json %dstDir%\Wexflow.Server

:: MongoDB script
dotnet publish ..\src\netcore\Wexflow.Scripts.MongoDB\Wexflow.Scripts.MongoDB.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.MongoDB
...
:: RavenDB script
::dotnet publish ..\src\netcore\Wexflow.Scripts.RavenDB\Wexflow.Scripts.RavenDB.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.RavenDB
::copy netcore\linux\RavenDB\appsettings.json %dstDir%\Wexflow.Scripts.RavenDB

:: PostgreSQL script
dotnet publish ..\src\netcore\Wexflow.Scripts.PostgreSQL\Wexflow.Scripts.PostgreSQL.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.PostgreSQL
copy netcore\linux\PostgreSQL\appsettings.json %dstDir%\Wexflow.Scripts.PostgreSQL

:: SQLServer script
dotnet publish ..\src\netcore\Wexflow.Scripts.SQLServer\Wexflow.Scripts.SQLServer.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.SQLServer
copy netcore\linux\SQLServer\appsettings.json %dstDir%\Wexflow.Scripts.SQLServer

:: MySQL script
dotnet publish ..\src\netcore\Wexflow.Scripts.MySQL\Wexflow.Scripts.MySQL.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.MySQL
copy netcore\linux\MySQL\appsettings.json %dstDir%\Wexflow.Scripts.MySQL

:: SQLite script
dotnet publish ..\src\netcore\Wexflow.Scripts.SQLite\Wexflow.Scripts.SQLite.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.SQLite
copy netcore\linux\SQLite\appsettings.json %dstDir%\Wexflow.Scripts.SQLite

:: LiteDB script
dotnet publish ..\src\netcore\Wexflow.Scripts.LiteDB\Wexflow.Scripts.LiteDB.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.LiteDB
copy netcore\linux\LiteDB\appsettings.json %dstDir%\Wexflow.Scripts.LiteDB

:: Firebird script
::dotnet publish ..\src\netcore\Wexflow.Scripts.Firebird\Wexflow.Scripts.Firebird.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.Firebird
:::copy netcore\linux\Firebird\appsettings.json %dstDir%\Wexflow.Scripts.Firebird

:: Oracle script
dotnet publish ..\src\netcore\Wexflow.Scripts.Oracle\Wexflow.Scripts.Oracle.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.Oracle
copy netcore\linux\Oracle\appsettings.json %dstDir%\Wexflow.Scripts.Oracle

:: MariaDB script
::dotnet publish ..\src\netcore\Wexflow.Scripts.MariaDB\Wexflow.Scripts.MariaDB.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.MariaDB
::copy netcore\linux\MariaDB\appsettings.json %dstDir%\Wexflow.Scripts.MariaDB

:: Wexflow.Clients.CommandLine
dotnet publish ..\src\netcore\Wexflow.Clients.CommandLine\Wexflow.Clients.CommandLine.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Clients.CommandLine

:: Wexflow.Scripts.RunAllWorkflows
dotnet publish ..\src\netcore\Wexflow.Scripts.RunAllWorkflows\Wexflow.Scripts.RunAllWorkflows.csproj -r linux-x64 --configuration Release --force --output %~dp0\%dstDir%\Wexflow.Scripts.RunAllWorkflows
